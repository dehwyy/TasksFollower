...
const Component = ({}: IProps) => {
  const [isOpen, setOpen] = useState(true)
    return (
      <div className={`${isOpen ? "bottom-[75%]" : "bottom-0"} fixed left-0 right-0 flex justify-center transition-all duration-700`}>
        <div className='relative transition-all duration-700'>
          ...
          <div className={`${isOpen ? "top-[25%]" : "top-[100%] "} border-t-[3px] border-blue-800 overflow-y-scroll fixed bg-gradient-to-r from-blue-600 to-fuchsia-600 bottom-0 left-0 right-0 transition-all duration-700`}>
