...
import { tasksAtom, sortedTasksAtom } from '@/utlis/store/task.atom'
import { useCallback, useState } from 'react'
import { ITasksAtom } from '@/utlis/store/task.types'
...
const Page = () => {
  ...
  const dropHandler = useCallback(
    (e: React.DragEvent<HTMLDivElement>, task: ITasksAtom) => {
      e.preventDefault()
